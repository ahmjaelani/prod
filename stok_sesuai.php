...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
	 ...
	 <div class="container-fluid">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="terjual" name="terjual" value="<?php echo $terjual; ?>" placeholder="Masukan Stok Keluar" maxlength="50" onkeyup="sum();">
                  </div>
                </div>
        </div>
    ...
    <?php
       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              $terjual = mysql_real_escape_string($_POST["terjual"]);
              $terbeli = mysql_real_escape_string($_POST["terbeli"]);
              $sisa = mysql_real_escape_string($_POST["sisa"]);
    				  $insert = ($_POST["insert"]);
