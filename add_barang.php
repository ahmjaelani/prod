...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
    ...
    <!----------------KONTEN------------------->
	  ...
	  $kode=$nama=$hargabeli=$noserial=$keterangan=$kategori="";
	  $no = $_GET["no"];
	  $insert = '1';
	 ...
	 <div class="container-fluid">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="noserial" name="noserial" value="<?php echo $noserial; ?>" placeholder="Masukan Harga Jual" maxlength="20">
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                ...
                while ($row=mysqli_fetch_assoc($sql)){
                        if ($user==$row['no'])
                        echo "<option value='".$row['no']."' selected='selected'>".$row['nama']."</option>";
                        else
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          $noserial = mysql_real_escape_string($_POST["noserial"]);
        ...
        $result=mysqli_query($conn,$sql);
              ...
              if(mysqli_num_rows($result)>0){
                  ...
                  $sql1 = "update $tabeldatabase set nama='$nama', hargabeli='$hargabeli', noserial='$noserial', kategori='$kategori', keterangan='$keterangan' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
					 ...
					 $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$hargabeli','$noserial','$keterangan','$kategori','','','','')";
