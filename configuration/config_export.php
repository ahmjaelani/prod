...
$jumlahbayar=$rowa['data'];
   ?>
  <td><?php  echo mysql_real_escape_string($jumlahbayar); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['total']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['bayar']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['kembali']); ?></td>
...
$jumlahbeli=$rowa['data'];
   ?>
  <td><?php  echo mysql_real_escape_string($jumlahbeli); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['total']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['supplier']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['kasir']); ?></td>
					  </tr><?php
					;
				}
...
$jumlahbayar=$rowa['data'];
  ...
  <td><?php  echo mysql_real_escape_string($jumlahbayar); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['total']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['keluar']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['total']-$fill['keluar']); ?></td>
  <td><?php  echo mysql_real_escape_string($fill['kasir']); ?></td>
  <td>
					  </tr><?php
					;
